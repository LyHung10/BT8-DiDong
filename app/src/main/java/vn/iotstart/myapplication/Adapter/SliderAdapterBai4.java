...
public class SliderAdapterBai4 extends SliderViewAdapter<SliderAdapterBai4.SliderHolder> {
    private Context context;
    private ArrayList<Integer> arrayList;

    public SliderAdapterBai4(Context context, ArrayList<Integer> arrayList) {
